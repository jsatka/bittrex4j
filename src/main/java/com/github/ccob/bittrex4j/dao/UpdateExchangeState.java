...
public class UpdateExchangeState  {
    ...
    @JsonCreator
    public UpdateExchangeState(
        @JsonProperty("MarketName") @JsonAlias("M") String marketName,
        @JsonProperty("Nounce") @JsonAlias("N") long nounce,
        @JsonProperty("Buys") @JsonAlias("Z") MarketOrder[] buys,
        @JsonProperty("Sells")  @JsonAlias("S") MarketOrder[] sells,
